...
const withNseFilesAndPlistMods = (config) => {
    ...
    return (0, config_plugins_1.withDangerousMod)(config, [
        "ios",
        async (config) => {
            const sourceDir = path.join(config.modRequest.projectRoot, iosConstants_1.PLUGIN_SWIFT_PATH);
            ...
            /* --- COPY ALL FILES --- */
            // Copy Swift files
            for (const sourceFileName of iosConstants_1.NSE_SWIFT_SOURCE_FILES) {
...
const withXcodeProjectSettings = (config, props) => {
    return (0, config_plugins_1.withXcodeProject)(config, (newConfig) => {
        ...
        const extGroup = xcodeProject.addPbxGroup([...iosConstants_1.NSE_EXT_FILES, ...iosConstants_1.NSE_SWIFT_SOURCE_FILES], iosConstants_1.NSE_TARGET_NAME, iosConstants_1.NSE_TARGET_NAME);
        ...
        xcodeProject.addBuildPhase(iosConstants_1.NSE_SWIFT_SOURCE_FILES, "PBXSourcesBuildPhase", "Sources", nseTarget.uuid);
